...
const Memos = ({ state }) => {
  ...
  return (
    ...
    <div style={{ display: "flex", justifyContent: "center" ,marginTop:"30px"}}>
      <div style={{ margin: "0 auto",textAlign: "center", fontWeight: "bold", margin: "10px", marginBottom: "30px", backgroundColor: "#b0c4de" , padding:"1px",width: "50%",fontFamily: "Verdana, sans-serif",border:"1px solid black",borderRadius:"10px"}}>
  ...
  {/* return (
    <>
      ...
      {showTransactions &&  memos.map((memo) => {
        ...
        return (
          <div
            className="container-fluid" style={{ width: "100%" }} key={Math.random()}>
            <table style={{ marginBottom: "10px",  tableLayout: "fixed", width: "100%" }}>
              <tbody>
                <tr>
                  <td
                    style={{
